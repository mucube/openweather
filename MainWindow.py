...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nameInputLayout.addWidget(self.searchbar)
        self.nameSubmitButton = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.nameSubmitButton.setFont(font)
        self.nameSubmitButton.setObjectName("nameSubmitButton")
        self.nameInputLayout.addWidget(self.nameSubmitButton)
        self.verticalLayout_2.addLayout(self.nameInputLayout)
        ...
        self.placeNameLabel = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(22)
        self.placeNameLabel.setFont(font)
        self.placeNameLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.placeNameLabel.setObjectName("placeNameLabel")
        self.verticalLayout_2.addWidget(self.placeNameLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nameSubmitButton.setText(_translate("MainWindow", "Submit"))
        ...
        self.placeNameLabel.setText(_translate("MainWindow", "New York"))
        self.fullNameLabel.setText(_translate("MainWindow", "New York, United States"))
